...
if (isset($_GET["student_code"])) {
    ...
    $stmt = $conn->prepare("SELECT student_id, type_name, student_name, student_lastname, student_nickname, student_pic, 
    student_citizen, student_email, student_mobile, student_facebook, student_line, st_address, st_tambol, st_ampher, 
    st_province, st_zipcode, st_tel, st_contact, st_mobile, ct_address, ct_tambol, ct_ampher, ct_province, 
    ct_zipcode, ct_tel, company_id FROM student WHERE student_code = ?");
