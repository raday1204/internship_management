...
@Component({
  selector: 'app-search-report-form-officer',
  templateUrl: './search-report-form-officer.component.html',
  styleUrls: ['./search-report-form-officer.component.css']
})
export class SearchReportFormOfficerComponent {
  selectedOption1: any;
  selectedOption2: any;
